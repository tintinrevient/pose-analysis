...
def normalize_pose(keypoints, show):
    '''
    for keypoints of one person
    '''
...
def process_keypoints(infile, output_dict={}, output_index=[], show=False):
    ...
    for keypoints in data['keypoints']:
        ...
        image_norm = normalize_pose(keypoints=rotated_keypoints, show=show)
...
if __name__ == '__main__':
    ...
    if os.path.isfile(args.input):
        process_keypoints(infile=args.input, show=True)
